...
sf::Vector2f P1Controls::GetLeftStickAxis()
{
	return m_leftAnalogStick;
}

sf::Vector2f P1Controls::GetRightStickAxis()
{
	return m_rightAnalogStick;
}

P1Controls& P1Controls::Instance()
{
	static P1Controls instance = P1Controls();
	return instance;
}

void P1Controls::Update()
{
...
bool P1Controls::CheckIfControllerIsConnected()
{
